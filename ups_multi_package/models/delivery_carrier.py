    ...
    def ups_send_shipping(self, pickings):
        ...
        for picking in pickings:
            ...
            if picking.delivery_package_ids:
                for pack in picking.delivery_package_ids:
                    packages.append(Package(self,0.0,delivery_package=pack))
            ...
            if picking.delivery_package_ids:
                package_type = self.ups_default_package_type_id.shipper_package_code or '02'
            else:
            ...
            package_labels = []
            for rec in result.get('label_binary_data'):
                
                package_labels = package_labels + [(rec[0], rec[1])]
