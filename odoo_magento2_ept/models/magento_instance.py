...
class MagentoInstance(models.Model):
    ...
    magento_stock_field = fields.Selection([('free_qty', 'On Hand Quantity'),
    ...
    last_order_import_date = fields.Datetime(string="Last Orders import date",
    ...
    auto_import_sale_orders = fields.Boolean(string="Auto Import Sale Orders?", default=False,
    ...
    def _scheduler_import_product(self, args=None):
        ...
        if instance_id:
            ...
            to_date = datetime.now()
            product_queue.create_product_queues(instance, from_date, to_date, is_update)
            instance.write({
    ...
    def _scheduler_update_order_status(self, args=None):
        ...
        if args.get('magento_instance_id', 0):
            ...
            if instance:
                ...
                pickings.magento_send_shipment(raise_error=False)
        return True
